...
export const SPOTIFY_LOAD_PLAYLIST_LIST = 'SPOTIFY_LOAD_PLAYLIST_LIST';
export const SPOTIFY_LOAD_MY_PLAYLIST_FAILURE = 'SPOTIFY_LOAD_MY_PLAYLIST_FAILURE';
export const SPOTIFY_LOAD_MY_PLAYLIST_SUCCESS = 'SPOTIFY_LOAD_MY_PLAYLIST_SUCCESS';
...
export const APP_SHOW_PLAYLIST = 'APP_SHOW_PLAYLIST';
...
export function loadPlaylistLists() {
  return (dispatch) => {
    ...
    getListOfPlaylists.then(data => {
        dispatch({ type: SPOTIFY_LOAD_MY_PLAYLIST_SUCCESS, data: data });
    }).catch(e => {
        dispatch({ type: SPOTIFY_LOAD_MY_PLAYLIST_FAILURE, error: e });
    });
  };
}
